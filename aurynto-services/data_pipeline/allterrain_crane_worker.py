    ...
    try:
        ...
        values = [
            (
                ...
                msg.get('load_weight'),
                msg.get('engine_temp'),
                msg.get('coolant_temp'),
                msg.get('rpm'),
                msg.get('engine_hours'),
                msg.get('boom_length'),
                msg.get('boom_angle'),
                msg.get('outrigger_extended'),
                msg.get('steering_mode'),
                msg.get('drive_mode'),
        ...
        cur.executemany("""
            INSERT INTO telemetry (
                ...
                rpm, engine_hours, battery_v, asset_table_id, boom_length, boom_angle, track_pressure, location, steering_mode, drive_mode 
            ) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, ST_GeomFromEWKT(%s))
        """, values)
