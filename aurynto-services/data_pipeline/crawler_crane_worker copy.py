    ...
    try:
        ...
        cur.executemany("""
            INSERT INTO telemetry (
                ...
                rpm, engine_hours, battery_v, asset_table_id, boom_length, boom_angle, track_pressure, location
            ) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, ST_GeomFromEWKT(%s))
        """, values)
