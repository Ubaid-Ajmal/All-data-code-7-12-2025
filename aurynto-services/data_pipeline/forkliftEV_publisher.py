...
while True:
    message_to_send = {"asset_id": ASSET_ID,
                       ...
                       "temperature": round(random.uniform(0, 100), 1),  
                        ...
                        "fork_height": round(random.uniform(0, 10), 0),
                        "battery_v": round(random.uniform(11.5, 14.5), 1),
                        "battery_charge": round(random.uniform(0, 100), 1),
                        "battery_temperature": round(random.uniform(0, 100), 1),
                        "charging_status": random.choice(["Plugged In", "Not Plugged In"]),
