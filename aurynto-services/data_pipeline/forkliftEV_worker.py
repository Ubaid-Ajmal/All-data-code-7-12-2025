    ...
    try:
        ...
        values = [
            (
                ...
                msg.get('fork_height'),
                msg.get('battery_v'),
                msg.get('battery_charge'),
                msg.get('battery_temperature'),
                msg.get('charging_status'),
        ...
        cur.executemany("""
            INSERT INTO telemetry (
                ...
                load_weight, fork_height, battery_v, battery_charge, 
                battery_temperature, charging_status, asset_table_id, location
            ) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, ST_GeomFromEWKT(%s))
        """, values)
